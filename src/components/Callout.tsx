interface CalloutProps {
  ...
  type?: 'info' | 'warning' | 'success' | 'tip' | 'ai';
  title?: string;
}
...
export function Callout({ children, type = 'info', title }: CalloutProps) {
  const styles = {
    ...
    ai: {
      container: 'bg-cyan-50 dark:bg-cyan-950/30 border-cyan-500 dark:border-cyan-700',
  ...
  const icons = {
    ...
    ai: (
      <>
        ...
        <circle cx="8.5" cy="6.5" r="0.75" />
        <circle cx="11.5" cy="6.5" r="0.75" />
        <rect x="9" y="2" width="2" height="1.5" rx="0.5" />
        <circle cx="10" cy="1.5" r="0.5" />
        <rect x="7" y="10" width="6" height="6" rx="0.5" />
        <rect x="6" y="12" width="1.5" height="3" rx="0.3" />
        <rect x="12.5" y="12" width="1.5" height="3" rx="0.3" />
        <rect x="8" y="16.5" width="1.5" height="2" rx="0.3" />
        <rect x="10.5" y="16.5" width="1.5" height="2" rx="0.3" />
        <line x1="9" y1="13" x2="11" y2="13" stroke="currentColor" strokeWidth="0.5" />
      </>
    ),
  };
